defmodule GardenTogether.UserManagerTest do
  # TODO: update tests
  use GardenTogether.DataCase
  ...
  describe "users" do
    ...
    test "register_user/1 with valid data creates a user" do
      assert {:ok, %User{} = user} = UserManager.register_user(@valid_attrs)
    ...
    test "register_user/1 with invalid data returns error changeset" do
      assert {:error, %Ecto.Changeset{}} = UserManager.register_user(@invalid_attrs)
    end
